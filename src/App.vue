...
// import { acqImageViewer } from "@didi/kata-ui";
const acqImageViewer = require("@didi/kata-ui/lib/acq-image-viewer").default;
console.log("acqImageViewer", acqImageViewer);
